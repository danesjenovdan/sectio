...
define( 'YOURLS_DB_USER', 'sectio' );

/** MySQL database password */
//define( 'YOURLS_DB_PASS', 'root' );
define( 'YOURLS_DB_PASS', 'sectio' );

/** The name of the database for YOURLS */
//define( 'YOURLS_DB_NAME', 'sect.io' );
define( 'YOURLS_DB_NAME', 'sectio' );
...
define( 'YOURLS_SITE', 'http://sectio.knedl.si' );

// preveri, če je referer drugačen od REFERER_CHECK, pol je zihr referer
define( 'REFERER_CHECK', 'sectio.knedl.si' );
...
$yourls_user_passwords = array(
	'admin' => 'vidmo01',
	'fd7g6dfughdf7t5hu' => '58utru8ge5zhtR_54zt45'	// You can have one or more 'login'=>'password' lines
	);
