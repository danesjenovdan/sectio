...
*/
 ...
 $ACCESS_PWD='vidmo123'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"sectio",#required
 'pwd'=>"sectio", #required
 'db'=>"sectio",  #optional, default DB
